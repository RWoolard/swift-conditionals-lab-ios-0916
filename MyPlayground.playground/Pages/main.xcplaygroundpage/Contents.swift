...
func goodBanker(firstAcct: Double, secondaryAcct: Double){
    
    
    if secondaryAcct > 0.00 {
      let newSecondaryAcct = secondaryAcct - 10.00
      let newFirstAcct = firstAcct + 10.00
       print(newFirstAcct)
       print(newSecondaryAcct)
    }
    
}


goodBanker(30.00, secondaryAcct: 20.00)
/*:
